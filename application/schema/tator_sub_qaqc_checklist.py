...
class TatorSubQaqcChecklist(Document):
    ...
    missing_megahabitat = IntField(required=True, min_value=0, max_value=2)
    missing_substrate = IntField(required=True, min_value=0, max_value=2)
    ...
    def json(self):
        return {
            ...
            'missing_megahabitat': self.missing_megahabitat,
            'missing_substrate': self.missing_substrate,
